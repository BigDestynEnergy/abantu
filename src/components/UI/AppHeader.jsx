...
export default function AppHeader({user}){
    ...
    function navigateTabs(label){
        ...
        if(label === 'Reader')navigate('/home/reader')
        if(label === 'Downloads')navigate('/home/downloads')
        if(label === 'Community')navigate('/home/community')
        if(label === 'Settings')navigate('/home/settings')
    }
    return(
        <header className="App-header">
            <div className="search">
                <input type="search" placeholder="search for comics here" />
                <img src={search}/>
            </div>
